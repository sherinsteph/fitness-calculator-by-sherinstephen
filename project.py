...
def fetch():
    ...
    Label(fetcher,text = "ENTER YOUR ID HERE").pack()
...
def id_validator(id_ftch):
    try:
        ...
        conn = sqlite3.connect("ftscal.db")
...
def fetchit(list):
    ...
    frame6.pack(fill="x")
    fet1 = Label(frame6,text="Name  :",fg = "white",bg = "blue",height = "0",font=("Helvetica", 16))
    fet1.grid(column=0,row=0)
    fett1 =Label(frame6,text=list[1],fg = "white",bg = "blue",height = "0",font=("Helvetica", 16))
    fett1.grid(column=1,row=0)
    fet2 = Label(frame6,text = "Age  :",fg = "white",bg = "blue",height = "0",font=("Helvetica", 10))
    fet2.grid(column=0,row=1)
    fett2 = Label(frame6,text = list[3],fg = "white",bg = "blue",height = "0",font=("Helvetica", 10))
    fett2.grid(column=1,row=1)
    fet3 = Label(frame6,text = "Gender  :",fg = "white",bg = "blue",height = "0",font=("Helvetica", 10))
    fet3.grid(column=0,row=2)
    fett3 = Label(frame6,text = list[2],fg = "white",bg = "blue",height = "0",font=("Helvetica", 10))
    fett3.grid(column=1,row=2)
    fet4 = Label(frame6,text="ID   :",fg = "white",bg = "blue",height = "0",font=("Helvetica", 10))
    fet4.grid(column=0,row=3)
    fett4 =Label(frame6,text=list[0],fg = "white",bg = "blue",height = "0",font=("Helvetica", 10))
    fett4.grid(column=1,row=3)
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------
#database saving
def save(a,b,c,d,e,f,g,h,i,gender,age_s):
    print("working")
    import sqlite3
    conn = sqlite3.connect("ftscal.db")
    id = int(idgen())
    if gender == 1:
        ...
        gendata ="Female"
    name = name_entry.get()
    parms = [id,name,gendata,age_s,str(a),b,c,d,e,f,g,h,i]
    ...
    messagebox.showinfo("Successfull",f'Data saved sucessfully and your id unique id generated is - {id}')
...
def report():
    ...
    try:
        save_btn = Button(frame5, text="SAVE", command=lambda: save(a, b, c, d, e, f, g, h, i, gender, age))
...
weight_label = Label(frame4,text = "Weight :").grid(column = 0,row =0,sticky = 'w')
weight_entry = Entry(frame4,bd=2)
weight_entry.grid(column = 2,row =0,sticky = 'e')


height_label = Label(frame4,text = "Height :").grid(column = 0,row =2,sticky = 'w')
height_entry = Entry(frame4,bd=2)
height_entry.grid(column = 2,row =2,sticky = 'e')


bplow_label = Label(frame4,text = "BP low :").grid(column = 0,row =3,sticky = 'w')
bplow_entry = Entry(frame4,bd=2)
bplow_entry.grid(column = 2,row =3,sticky = 'e')


bphigh_label = Label(frame4,text = "BP high :").grid(column = 0,row =4,sticky = 'w')
bphigh_entry = Entry(frame4,bd=2)
bphigh_entry.grid(column = 2,row =4,sticky = 'e')


pulserate_label = Label(frame4,text = "Pulse Rate :").grid(column = 0,row =5,sticky = 'w')
pulserate_entry = Entry(frame4,bd=2)
pulserate_entry.grid(column = 2,row =5,sticky = 'e')


rbc_label = Label(frame4,text = "RBC Count :").grid(column = 0,row =6,sticky = 'w')
rbc_entry = Entry(frame4,bd=2)
rbc_entry.grid(column = 2,row =6,sticky = 'e')


wbc_label =Label(frame4,text = "WBC Count :").grid(column = 0,row =7,sticky = 'w')
wbc_entry = Entry(frame4,bd=2)
wbc_entry.grid(column = 2,row =7,sticky = 'e')


platelets_label = Label(frame4,text = "Platelets :").grid(column = 0,row =8,sticky = 'w')
platelets_entry = Entry(frame4,bd=2)
platelets_entry.grid(column = 2,row =8,sticky = 'e')


hb_label = Label(frame4,text = "HB :").grid(column = 0,row =9,sticky = 'w')
hb_entry = Entry(frame4,bd=2)
hb_entry.grid(column = 2,row =9,sticky = 'e')


uricacid_label = Label(frame4,text = "Uric Acid :").grid(column = 0,row =10,sticky = 'w')
uricacid_entry = Entry(frame4,bd=2)
uricacid_entry.grid(column = 2,row =10,sticky = 'e')


Cholesterol_label = Label(frame4,text = "Cholesterol :").grid(column = 0,row =11,sticky = 'w')
...
fetchdata=Button(root,text = 'Fetch Data',image=image4,command = fetch)
fetchdata.pack()
